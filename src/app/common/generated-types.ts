...
export namespace GetOrderList {
    ...
    export type ActiveCustomer = NonNullable<
        GetOrderListQuery["activeCustomer"]
    >;
...
export namespace GetShippingAddress {
    ...
    export type ActiveOrder = NonNullable<
        GetShippingAddressQuery["activeOrder"]
    >;
    export type ShippingAddress = NonNullable<
...
export namespace Cart {
    ...
    export type ProductVariant = NonNullable<
        NonNullable<
            NonNullable<CartFragment["lines"]>[number]
        >["productVariant"]
    >;
...
export namespace GetProductDetail {
    ...
    export type Assets = NonNullable<
        NonNullable<
            NonNullable<GetProductDetailQuery["product"]>["assets"]
        >[number]
    >;
...
export namespace AddToCart {
    ...
    export type AddItemToOrder = NonNullable<
        AddToCartMutation["addItemToOrder"]
    >;
...
export namespace SearchProducts {
    ...
    export type PriceWithTax = NonNullable<
        NonNullable<
            NonNullable<
                NonNullable<SearchProductsQuery["search"]>["items"]
            >[number]
        >["priceWithTax"]
    >;
...
export type GetOrderListQuery = { __typename?: "Query" } & {
    activeCustomer?: Maybe<
        { __typename?: "Customer" } & Pick<Customer, "id"> & {
                orders: { __typename?: "OrderList" } & Pick<
                    OrderList,
                    "totalItems"
                > & {
                        items: Array<
...
export type GetOrderByCodeQuery = { __typename?: "Query" } & {
    orderByCode?: Maybe<
        { __typename?: "Order" } & Pick<Order, "updatedAt" | "payments"> & {
                customer?: Maybe<
                    { __typename?: "Customer" } & Pick<
                        Customer,
...
export type GetEligiblePaymentMethodsQuery = { __typename?: "Query" } & {
    eligiblePaymentMethods: Array<
        { __typename?: "PaymentMethodQuote" } & Pick<
            PaymentMethodQuote,
            "id" | "code" | "eligibilityMessage" | "isEligible" | "customFields"
        >
    >;
};
...
export type GetCustomerAddressesQuery = { __typename?: "Query" } & {
    activeCustomer?: Maybe<
        { __typename?: "Customer" } & Pick<Customer, "id"> & {
                addresses?: Maybe<
                    Array<{ __typename?: "Address" } & AddressFragment>
                >;
            }
    >;
};
